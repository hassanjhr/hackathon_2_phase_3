  ...
  return (
    <div className="flex gap-2 p-4 border-t border-gray-200 bg-white">
      <textarea
        ...
        disabled={disabled}
        rows={1}
        className="flex-1 resize-none rounded-lg border border-gray-300 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50 disabled:bg-gray-50 text-gray-900"
      />
      <button
        onClick={handleSend}
